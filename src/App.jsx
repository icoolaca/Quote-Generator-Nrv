    ...
    <div style={{ fontFamily: "'Barlow',sans-serif", background: "#F0F0F0", minHeight: "100vh", color: "#1A1A1A" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "20px 12px 80px" }} className="no-print">
        ...
        <div className="nv-card" style={{ background: "#FFF", borderRadius: 6, overflow: "hidden", marginBottom: 16, border: "1px solid #E0E0E0" }}>
          ...
          <div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", fontSize: F.small, fontWeight: 800, textTransform: "uppercase", color: "#FFF", background: "#C8102E" }} className="nv-resp-5 nv-desk-header">{["Customer #", "Carrier", "PO #", "Ship Date", "Salesperson"].map(h => <div key={h} className="nv-hdr-cell" style={{ padding: "5px 10px" }}>{h}</div>)}</div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", background: "#FAFAFA", borderBottom: "1px solid #E5E5E5" }} className="nv-resp-5">{[{ v: s.customerNo, k: "customerNo", l: "Customer #" }, { v: s.carrier, k: "carrier", l: "Carrier" }, { v: s.poNumber, k: "poNumber", l: "PO #" }, { v: s.shipDate, k: "shipDate", type: "date", l: "Ship Date" }, { v: s.salesperson, k: "salesperson", l: "Salesperson" }].map(f => <div key={f.k} style={{ padding: "4px 8px", borderRight: "1px solid #E5E5E5" }}>
